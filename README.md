...
running command...
$ katools (--version)
katools/0.2.1 win32-x64 node-v20.11.1
...
running command...
$ katools (--version)
katools/0.2.0 linux-x64 node-v18.20.5
$ katools --help [COMMAND]
USAGE
  $ katools COMMAND
...
...
_See code: [src/commands/component.ts](https://github.com/KeSuave/katools/blob/v0.2.0/src/commands/component.ts)_
...
_See code: [src/commands/entity.ts](https://github.com/KeSuave/katools/blob/v0.2.0/src/commands/entity.ts)_
...
_See code: [src/commands/init.ts](https://github.com/KeSuave/katools/blob/v0.2.0/src/commands/init.ts)_
...
_See code: [src/commands/scene.ts](https://github.com/KeSuave/katools/blob/v0.2.0/src/commands/scene.ts)_
<!-- commandsstop -->
