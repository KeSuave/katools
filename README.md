...
running command...
$ katools (--version)
katools/0.5.1 linux-x64 node-v18.20.5
...
_See code: [src/commands/component.ts](https://github.com/KeSuave/katools/blob/v0.5.1/src/commands/component.ts)_
...
_See code: [src/commands/entity.ts](https://github.com/KeSuave/katools/blob/v0.5.1/src/commands/entity.ts)_
...
_See code: [src/commands/init.ts](https://github.com/KeSuave/katools/blob/v0.5.1/src/commands/init.ts)_
...
_See code: [src/commands/scene.ts](https://github.com/KeSuave/katools/blob/v0.5.1/src/commands/scene.ts)_
<!-- commandsstop -->
