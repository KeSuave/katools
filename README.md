...
running command...
$ katools (--version)
katools/1.1.0 win32-x64 node-v22.17.0
...
running command...
$ katools (--version)
katools/1.0.14 linux-x64 node-v20.19.2
$ katools --help [COMMAND]
USAGE
  $ katools COMMAND
...
...
_See code: [src/commands/component.ts](https://github.com/KeSuave/katools/blob/v1.0.14/src/commands/component.ts)_
...
_See code: [src/commands/entity.ts](https://github.com/KeSuave/katools/blob/v1.0.14/src/commands/entity.ts)_
...
_See code: [src/commands/init.ts](https://github.com/KeSuave/katools/blob/v1.0.14/src/commands/init.ts)_
...
_See code: [src/commands/plugin.ts](https://github.com/KeSuave/katools/blob/v1.0.14/src/commands/plugin.ts)_
...
_See code: [src/commands/scene.ts](https://github.com/KeSuave/katools/blob/v1.0.14/src/commands/scene.ts)_
<!-- commandsstop -->
